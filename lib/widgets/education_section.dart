                    ...
                    (index) {
                      ...
                      return Padding(
                        padding: EdgeInsets.only(
                          bottom: index == _education.length - 1 ? 0 : 18,
                        ),
                        child: Row(
                    ...
                    _buildDesktopTile(
                      child: Row(
                        children: [
                          Expanded(
                            child: _buildEducationCard(
                              degree: _education[0]['degree']!,
                              institution: _education[0]['institution']!,
                              location: _education[0]['location']!,
                              dates: _education[0]['dates']!,
                              isHighlighted: true,
                              cardColor: cardColor,
                              textPrimary: textPrimary,
                              isDark: isDark,
                    ...
                    _buildDesktopTile(
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: _buildEducationCard(
                              degree: _education[1]['degree']!,
                              institution: _education[1]['institution']!,
                              location: _education[1]['location']!,
                              dates: _education[1]['dates']!,
                              isHighlighted: false,
                              cardColor: cardColor,
                              textPrimary: textPrimary,
                              isDark: isDark,
    ...
    return TimelineTile(
      ...
      indicatorStyle: IndicatorStyle(
        ...
        indicator: Container(
          ...
          child: highlight
              ? const Icon(Icons.school, size: 10, color: Colors.white)
              : null,
        ),
      ),
  ...
  static const List<Map<String, String>> _education = [
    {
      ...
      'institution': 'ISPACE CYBER SECURITY COLLEGE',
      'location': 'Ho Chi Minh',
      'dates': '2025 - Present',
    },
    {
      'degree': 'FINAL YEAR (COMPUTER SCIENCE)',
